...
Многостраничный сайт **MENTORI TECHNOLOGIES**. Компания проектирует и внедряет системы под процессы бизнеса: клиенты, заказы, финансы, производство, доставки, работу команды и интеграции.
...
горизонтальная swipe-карусель услуг на странице «Что делаем», компактные раскрывающиеся карточки внутренней работы, hero-ротатор заголовков.
