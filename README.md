...
`data-tilt` (наклон 3D), sticky-стек на десктопе и круговая 3D-карусель тех же карточек на мобильном,
горизонтальная swipe-карусель услуг на странице «Что делаем», hero-ротатор заголовков.
...
горизонтального overflow нет, touch-таргеты ≥44px, мобильные карусели поддерживают свайп,
стрелки и индикаторы, светлая тема покрывает все внутренние элементы.
