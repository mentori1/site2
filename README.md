# Mentra — лендинг агентства

Многостраничный сайт AI-агентства **Mentra** (продажи и обработка клиентов на автомате).
...
| Файл | Назначение |
|------|------------|
| `index.html` | Главная: hero-ротатор → где теряются деньги → процесс → экспертиза → 4 сценария → производство → безопасность → тарифы → CTA |
